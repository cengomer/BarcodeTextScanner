...
struct ContentView: View {
    ...
    var body: some View {
        ...
        case .cameraNotAvailable:
            Text("Your device doens't have a camera")
        case .scannerNotAvailable:
            Text("Your device doens't have support for scanning barcode with this app")
        ...
        DataScannerView(recognizedItems: $vm.recognizedItems,
            ...
            .sheet(isPresented: .constant(true), content: {
                bottomContainerView
                    ...
                    .onAppear {
                        // if the ultraThinMaterial didn't work apply these
